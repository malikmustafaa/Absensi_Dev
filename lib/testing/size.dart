...
// class Sizekona {
//   const Sizekona._(this._json);

//   /// The inverse of .toJson.
//   @Deprecated('No longer supported')
//   Sizekona.fromJson(Object json) : _json = json {
...
//   static const String _fromBytes4 = 'fromBytes4';
...
//   /// Creates a Sizekona that refers to the default marker image.
//   static const Sizekona defaultMarker = Sizekona._(<Object>[_defaultMarker]);

//   /// Creates a Sizekona that refers to a colorization of the default
//   /// marker image. For convenience, there is a predefined set of hue values.
//   /// See e.g. [hueYellow].
//   static Sizekona defaultMarkerWithHue(double hue) {
//     assert(0.0 <= hue && hue < 360.0);
//     return Sizekona._(<Object>[_defaultMarker, hue]);
//   }

//   /// Creates a [Sizekona] from an asset image.
//   ///
...
//   static Future<Sizekona> fromAssetImage(
...
//   /// Creates a Sizekona using an array of bytes that must be encoded
//   /// as PNG.
...
//   static Sizekona fromBytes4(Uint8List byteData, int width) {
//     assert(byteData.isNotEmpty, 'Cannot create Sizekona with empty byteData');
//     return Sizekona._(<Object>[
//       _fromBytes4,
//       byteData,
//       if (kIsWeb)
